...
function getOrderInfo(orderno){
	$.post("${ctx}/order/getOrderInfo", {orderno:orderno},function(data){
		if(data != "-1"){
			var result = eval(data);
		...
		<div class="table-box-backend page-manage-box-outer dclear clearfix" style="width:1020px;">
			<div class="table-body page-table-body" style="width:1020px;">
				...
				<div class="historty-table-con-outer-backend dclear">
					<div class="history-table-con-inner manage-page-inner clearfix" style="margin-bottom: 0px !important; background:#E0E0E0;">
						<div class="dleft">
							<div style="background:#E0E0E0; width:200px; height:37px;text-align:center; padding-top:8px; margin-left:0px;border-bottom: 1px solid #cccccc;" id="searchorder_dev">
								<input id="searchorderKey_li" name="searchorderKey_li" style="width:160px; height:30px;" class="showTip" value="输入账号搜索" />
							</div>
							...
							<div style="background:#E0E0E0; width:200px; height:50px;text-align:center;padding-top:5px;">
								<a href="javascript:void(0)" class="pill button" style="padding-bottom:5px !important;"  onclick="toAddPage()"><strong>&nbsp;&nbsp;创建新账号&nbsp;&nbsp;</strong></a>
							</div>
						</div>
						<!-- ---------------------------left end -------------------------- -->
						<div class="manage-page-right-backend dright" id="userInfoShow">
							<div class="manage-page-item" style="width:810px;">
								<div class="manage-page-item-inner clearfix" style="width:810px;">
									<div class="manage-page-right-backend dright" style="padding-bottom:5px; border-bottom:1px solid #ccc;">
									...
									<div class="manage-page-right-backend dright" id="subUser_show">
										<div style="padding-left:20px; width:810px; text-align:left; margin-top:15px;margin-bottom:10px;"><b>子账号信息</b></div>
							...
							<div style="width:810px; text-align:left; height:32px; padding-top:8px;">
								<b style="margin-left:20px;margin-top:20px;">设备信息</b>
								<a href="javascript:void(0)" class="button" style="margin-left:650px;"  onclick="toAddDtuDialog()"><strong>添加设备</strong></a>
							</div>
								...
								<div class="table-body2" style=" width:810px;">
									<table class="dclear" style=" width:810px;">
											<tr class="trHead">
												...
												<th style="width:110px;">产品信息</th>
												<th style="width:110px;">硬件版本号</th>
												<th style="width:160px;">SN码</th>
												<th style="width:180px;">UUID</th>
												<th style="width:90px;">设备来源</th>
												<th style="width:130px;">添加日期</th>
											</tr>
									</table>
								</div>
							</div>
							<div class="manage-page-left dleft" style="margin-top:0px; height:250px; width:810px; background: #FFF;">
								<div class="table-body2" style=" width:810px;">
									<table class="dclear" style=" width:810px;">
									...
									<div class="manage-page-right-backend dright" style="border-bottom:1px solid #ccc;padding-bottom:5px;">
										...
										<table class="dclear" style="width:810px;" >
											...
											<tr>
												...
												<td style="text-align:right; width:90px; border:0px; height:30px;">录&nbsp;&nbsp;单&nbsp;人：</td>
												<td style="text-align:left; width:170px; border:0px; height:30px;" id="show_ldr"> </td>
												<td style="text-align:right; width:90px; border:0px; height:30px;">录单时间：</td>
												<td style="text-align:left; border:0px; height:30px;" id="show_opttime"> </td>
											</tr>
										</table>
									</div>
									<div class="manage-page-right-backend dright">
