								...
								<table class="dclear" style="width:620px;margin-left:190px;" id="show_permission_table">
									...
									<tr >
										<td style="text-align:left; border:0px;" >
											<label style="margin-right:25px;"><input type="checkbox" id="show_permission_1" name="permission" value="1" disabled="disabled" /> 管理员 </label>
										</td>
										<td style="text-align:left; border:0px;" >
											<label style="margin-right:25px;"><input type="checkbox" id="show_permission_2" name="permission" value="2" disabled="disabled" /> 普通用户 </label>
										</td>
							...
							<div class="manage-page-right-backend dright" style="height:630px; background:#FFF;">
								...
								<div class="manage-page-item">
									...
									<table class="dclear" style="width:620px;margin-left:190px;" >
										...
										<tr >
											<td style="text-align:left; border:0px;" >
												<label style="margin-right:25px;"><input type="checkbox" id="edit_permission_1" name="permission" value="1" /> 管理员 </label>
											</td>
											<td style="text-align:left; border:0px;" >
												<label style="margin-right:25px;"><input type="checkbox" id="edit_permission_2" name="permission" value="2" /> 普通用户 </label>
											</td>
							...
							<div class="manage-page-right-backend dright" style="height:630px; background:#FFF;">
								...
								<div class="manage-page-item">
									...
									<table class="dclear" style="width:620px;margin-left:190px;" >
										...
										<tr >
											<td style="text-align:left; border:0px;" >
												<label style="margin-right:25px;"><input type="checkbox" id="add_permission_1" name="permission" value="1" /> 管理员 </label>
											</td>
											<td style="text-align:left; border:0px;" >
												<label style="margin-right:25px;"><input type="checkbox" id="add_permission_2" name="permission" value="2" /> 普通用户 </label>
											</td>
											<td style="text-align:left; border:0px;" colspan="2" >
												&nbsp;
											</td>
