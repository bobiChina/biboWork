		...
		<div class="head-wrap" style="width:1010px;">
			...
			<div class="head-nav dleft" style="width:510px;">
				<div class="head-nav-item"  style="width:100px;">
					<a href="${ctx}/customer/page" style="width:100px;" <c:if test="${currentMenu == 'backend_customer'}"> class="activenav" </c:if>>客户管理</a>
				</div>
				<div class="head-nav-item"  style="width:100px;">
					<a href="${ctx}/order/page" style="width:100px;" <c:if test="${currentMenu == 'backend_order'}"> class="activenav" </c:if>>订单管理</a>
				</div>
				<div class="head-nav-item"  style="width:100px;">
					<a href="${ctx}/product/page" style="width:100px;" <c:if test="${currentMenu == 'backend_product'}"> class="activenav" </c:if>>版本管理</a>
				</div>
				<div class="head-nav-item"  style="width:100px;">
