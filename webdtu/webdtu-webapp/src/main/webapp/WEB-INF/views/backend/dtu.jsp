...
<body>
	...
	<div class="body-outer dclear clearfix">
		<div class="form-box clearfix">
			...
			<a href="${ctx}/manager/dtu/add" class="btn btn-success btn-sm">添加</a>
		</div> <!-- //form end -->
			...
			<div class="table-body">
				<table id="container" class="dclear">
					<thead class="displavisibility">
						<tr>
							<th width="51" style="text-align: center;">序号</th>
						    <th width="160">uuid</th>
						    <th width="160">所属用户</th>
						    <th width="285">所属公司</th>
						    <th width="160">添加时间</th>
						    <th width="110" style="text-align: center;">删除</th>
					</thead>
					<tbody>
					<c:forEach var="dtu" items="${dtuList}" varStatus="status" >
				  		<tr>
				  			<td width="51"><c:out value="${status.count}"/></td>
				  			<td width="160">${dtu.uuid}</td>
				  			<td width="160">${dtu.dtuUser.fullName}</td>
				  			<td width="285">${dtu.dtuUser.corp.corpName}</td>
				  			<td width="160">${dtu.insertTime}</td>
				  			<td width="110"><a href="${ctx}/manager/dtu/delete/${dtu.id}">删除</a></td>
				  		</tr>
				  	</c:forEach>
