...
$(function(){
	...
	$.get("${ctx}/overview/getTotalInfo", {},function(data){
       var result = eval('(' + data + ')');
		if(result.length > 3){
			$("#span_total_0").html(result[0]);
			$("#span_total_1").html(result[1]);
			$("#span_total_2").html(result[2]);
			$("#span_total_3").html(result[3]);
		}
    });
});
</script>
			...
			<div class="overview-outer clearfix dclear">
				<div class="overview-content">
					...
					<div class="overview-info overview-info-line dleft">
						<ul>
							<li><span class="overview-cart-title">总行驶里程（km）</span><span class="overview-cart-total" id="span_total_0">
								0
							</span></li>
							<li><span class="overview-cart-title">总运行时长（h）</span><span class="overview-cart-total" id="span_total_1">
								0
							</span></li>
						</ul>
					</div>
					...
					<div class="overview-info overview-dright dleft">
						<ul>
							<li><span class="overview-cart-title">最大单车行驶里程（km）</span><span class="overview-cart-total" id="span_total_2">
								0
							</span></li>
							<li><span class="overview-cart-title">最大单车运行时长（h）</span><span class="overview-cart-total" id="span_total_3">
								0
							</span></li>
						</ul>
					</div>	
