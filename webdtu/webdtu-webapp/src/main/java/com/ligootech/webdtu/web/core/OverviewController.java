...
//		sb.append("]");	
	...
	@RequestMapping(value = "/getTotalInfo", method = RequestMethod.GET,produces = "plain/text; charset=UTF-8")
	@ResponseBody
	public String getTotalInfo(){
		...
		String rsStr = JSONArray.fromObject(allMilegeAndTimeLength).toString();
