...
public class Excel2007Reader {
    ...
    class MyXSSFSheetHandler extends DefaultHandler {
        ...
        public void endElement(String uri, String localName, String name)
            ...
            if ("v".equals(name)) {
                ...
                //output.println();
                //output.println("rowlist=" + rowlist.toString());
                rowlist.clear();
                curRow++;
    ...
    public void processSheet(
        ...
        ContentHandler handler = new MyXSSFSheetHandler(styles, strings, this.minColumns, System.out);
    ...
    public void process(String filePath)
            throws IOException, OpenXML4JException, ParserConfigurationException, SAXException, FileNotFoundException {
        ...
        while (iter.hasNext()) {
            ...
            //String sheetName = iter.getSheetName(); //sheet
            sheetIndex = index;//wly
            curRow = 0;//
            //this.output.println();
