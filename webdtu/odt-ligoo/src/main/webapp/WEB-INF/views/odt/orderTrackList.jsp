...
<html>
<head>
  <meta name="menu" content="orderTrack"/>
  <title>订单列表</title>
  ...
  <script type="text/javascript">
    ...
    function search() {
      ...
      $("#page").myPagination({
        ...
        ajax : {
          ...
          url : '${ctx}/orderTrack/listQuery',//访问服务器地址
          dataType : 'json', //返回类型
          param : {
            on : true,
            page : 1,
    ...
    function createTR(index,obj) {
      var tr = "<tr>";
      tr += "<td>" + index + "</td>";
      tr += "<td><a target='_blank' href='${ctx}/orderTrack/detail?orderno="+obj.orderno+"'>" + obj.orderno + "</a></td>";
      //tr += "<td><a target='_blank' href='${ctx}/orderTrack/detail?orderno="+obj.orderno+"'>" + obj.contract_no + "</a></td>";
      ...
      tr += "<td><a target='_blank' href='${ctx}/orderTrack/detail?orderno="+obj.orderno+"'>" + "查看" + "</a></td>";
    ...
    <div class="table-body" style="min-height:487px;">
      <table id="container" class="dclear" width="100%">
        ...
        <tr>
          ...
          <th style="width: 90px; text-align: center;">订单日志</th>
         </tr>
        </thead>
        <tbody>
        </tbody>
