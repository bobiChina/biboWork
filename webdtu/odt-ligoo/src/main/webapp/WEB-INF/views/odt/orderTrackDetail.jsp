      ...
      <div class="order-info-con" align="center">
        <table>
          ...
          <tr>
            ...
            <td><a target='_blank' href='${ctx}/orderTrack/detail?orderno=${order.boundOrder}'>${order.boundOrder}</a></td>
          </tr>
          </c:if>
          <tr>
        ...
        <table class="reportbox-table reportbox-table-bg" style="margin-bottom: 8px;">
          ...
          <th width="*">更改原因</th>
           ...
           <c:forEach items="${shList}" var="shObj" varStatus="status">
             <tr>
               <td style="width: 50px; background: #FFF;">${status.count}</td>
               <td style="width: 140px; background: #FFF;"><a target='_blank' href='${ctx}/orderTrack/detail?orderno=${shObj.orderno}'>${shObj.orderno}</a></td>
