 ...
 * 普通页面条件查询
 * @param {} tabId 表ID
 * @param {} queryParams 查询条件JSON格式 如：{"userid":"000100", "userloginno":"admin"}
 */
function searchNormalFun(tabId, queryParams){
    var dg = $('#' + tabId);
    //dg.datagrid('loadData', []);
    if(null != queryParams && undefined != queryParams ){
