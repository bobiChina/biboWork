...
(function ($) {
	...
	function init(param, obj) {
		if (param && param instanceof Object) {
			...
			var pageSize;
			var tempPage;
			var defaults = new Object({currPage:1, pageCount:10, pageSize:5, cssStyle:"badoo", ajax:{on:false, pageCountId:"pageCount", param:{on:false, page:1}, ajaxStart:function () {
				return false;
			}}, info:{first:"\u9996\u9875", last:"\u5c3e\u9875", next:"\u4e0b\u4e00\u9875", prev:"\u4e0a\u4e00\u9875", first_on:true, last_on:true, next_on:true, prev_on:true, msg_on:true, link:"#", msg:"<span>&nbsp;&nbsp;\u8df3至{currText}/{sumPage}\u9875</span>", text:{width:"22px"}}});
			...
			function createView(page) {
				...
				if (ajax.on) {
					...
					var varUrl = ajax.url;
					var param = getParam();
					$.ajax({url:varUrl, type:"POST", data:param, contentType:"application/x-www-form-urlencoded;utf-8", async:true, cache:false, timeout:60000, error:function () {
						//alert("\u8bbf\u95ee\u670d\u52a1\u5668\u8d85\u65f6\uff0c\u8bf7\u91cd\u8bd5\uff0c\u8c22\u8c22\uff01"); wly 去除弹出框提示（访问服务器超时，请重试，谢谢！）
