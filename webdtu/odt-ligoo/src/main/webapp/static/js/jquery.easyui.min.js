...
bb.num=$("<input class=\"pagination-num\" type=\"text\" style=\"text-align:center;\" value=\"1\" size=\"2\">").appendTo(tr).wrap("<td></td>");
...
}).bind("keyup.combo paste.combo drop.combo",function(e){
switch(e.keyCode){
case 38:
...
_8c0(this,q);
    ...
    var opts=$(this).combobox("options");
    //wly 2016年6月28日 09:08:48 从头位置改为任意位置匹配
